  ...
  <header id="header"> 
   <div class="topnav" id="mynav">
    ...
    <a href="booking.php">Booking</a>
     <center><a href="contact.php">Contact</a></center>
  </div>
...
<tr>
 <td>
      <img  src="images/deluxe.jpg" alt="The Hotel" width="800px" height="400px"> 
  </td>
  ...
  <td >
   ...
   <ul>
    <h2><b><i>All Akofena Deluxe rooms have</i></b></h2>
    <b><i>Deluxe Room (40 square meters)</i></b>
    <li>air conditioner and a ceiling fan</li>
    <li> Bathroom with walk-in showerr</li>
    <li>Double Hand Basins & Bidet</li>
    <li> mosquito net</li>
